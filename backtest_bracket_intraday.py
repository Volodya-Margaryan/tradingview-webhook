...
N_PERIODS = 14
HISTORY_PERIOD = "8y"
DB_PREFIX = "backtest_bracket_intraday"
...
def main() -> None:
    ...
    print("\n" + "=" * 100)
    print("INTRADAY-AWARE (High/Low) STOP/TARGET CHECK -- same strategy, same 14 periods, same $2,000 cap")
    print("=" * 100)
    ...
    print("(Compare to the close-only version, same $2,000 cap, same 14 periods: "
          "9/14 profitable, combined +$685.83.)")
